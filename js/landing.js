...
movies.forEach((movie) => {
  const{poster_path,title,vote_average, release_date,id,overview,backdrop_path } = movie;
...
document.getElementById("pagenation").style.display = "flex";
...
if(searchTerm){
  ...
  search.value = '';
  document.getElementById("title-text").style.display = "flex";
  ...
  document.getElementById("main").style.marginTop = "3rem"; 
